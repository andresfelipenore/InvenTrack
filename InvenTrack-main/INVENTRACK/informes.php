...
if (!isset($_SESSION['usuario'])) {
    ...
    // Calcular el total de ganancias sumando el campo total_venta de todas las órdenes
    while ($res = mysqli_fetch_array($sql)) {
        $ganancia += $res['total_venta'];
    }
    ?>
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <div class="card-header bg-primary text-white">
                <h3 class="card-title">Total ganancias <?php echo $m; ?> $ <?php echo number_format($ganancia, 2); ?></h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            // Reiniciar el puntero de resultados para recorrer nuevamente
